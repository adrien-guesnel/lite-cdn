/* biome-ignore lint/complexity/useLiteralKeys: Private methods need bracket notation to be accessed in tests */
...
describe("ImagesService", () => {
  ...
  describe("verifyKey", () => {
    ...
    it("should log error if API_SECRET not configured", () => {
      ...
      const testService = new ImagesService(mockConfigService as any, logger);
